...
#if defined (OPLUS_FEATURE_PREFER_SILVER) && defined (OPLUS_FEATURE_UIFIRST)
	...
	*backup_cpu = -1;
	...
	do {
		for_each_cpu_and(i, &p->cpus_allowed, sched_group_span(sg)) {
...
#endif /* OPLUS_FEATURE_PREFER_SILVER && OPLUS_FEATURE_UIFIRST*/
			 ...
			 * tasks.
			 */
#if defined (OPLUS_FEATURE_UIFIRST) && defined (OPLUS_FEATURE_PREFER_SILVER)
